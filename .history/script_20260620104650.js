...
if (Firewall.isAdmin()) {
      ...
      return `
            <div class="product-card" data-id="${p.id}" data-name="${p.name}" data-price="${p.price}" data-img="${p.img}">
              ...
              <div class="product-info">
                <div class="product-brand">${getCategoryLabel(p.categoryId, p.category) || BRAND_CONFIG.name}</div>
                <div class="product-name">${p.name}</div>
                <div class="product-price">${p.price.toLocaleString()} ${currencyCode}</div>
  ...
  const renderCart = () => {
    ...
    if (cart.length === 0) {
      ...
      if (subtotalEl) subtotalEl.textContent = `0 ${currencyCode}`;
      if (totalEl) totalEl.textContent = `500 ${currencyCode}`;
      return;
    }
    let subtotal = 0;
    cartItemsList.innerHTML = "";
        ...
        `
                <div class="cart-item">
                    ...
                    <div class="cart-item-info">
                        ...
                        <p class="cart-item-price">${item.price.toLocaleString()} ${currencyCode}</p>
    ...
    container.innerHTML = `
      ...
      <div class="product-view-layout product-view">
        ...
        <div class="product-view-details">
          ...
          <div>
            <div class="product-view-price">${priceStr} ${currencyCode}</div>
