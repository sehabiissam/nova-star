 ...
 *   2. Set sender email: firebase functions:config:set resend.from_email="noreply@zetspace.dz"
 *   3. npm install
...
const FROM_EMAIL = functions.config().resend?.from_email || "noreply@zetspace.dz";
