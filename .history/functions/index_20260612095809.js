/**
 * Steezy Newsletter Cloud Functions
 * 
 ...
 *   2. Set sender email: firebase functions:config:set resend.from_email="noreply@steezy-store.com"
 *   3. npm install
...
const FROM_EMAIL = functions.config().resend?.from_email || "noreply@steezy-store.com";
const STORE_NAME = "Steezy";
const STORE_URL = "https://steezy-store.com";
