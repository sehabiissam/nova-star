/**
 * 91s STORE Newsletter Cloud Functions
 * 
 ...
 *   2. Set sender email: firebase functions:config:set resend.from_email="noreply@91s-store.com"
 *   3. npm install
...
const FROM_EMAIL = functions.config().resend?.from_email || "noreply@91s-store.com";
const STORE_NAME = "91s STORE";
const STORE_URL = "https://91s-store.com";
