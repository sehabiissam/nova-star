/**
 * Levelup.wr Newsletter Cloud Functions
 * 
 ...
 *   2. Set sender email: firebase functions:config:set resend.from_email="noreply@levelup.wr"
 *   3. npm install
...
const FROM_EMAIL = functions.config().resend?.from_email || "noreply@levelup.wr";
const STORE_NAME = "Levelup.wr";
const STORE_URL = "https://levelup.wr";
