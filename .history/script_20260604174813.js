    ...
    grid.innerHTML = wishlist
      .map(
        ...
        <div class="product-card" data-id="${item.id}" data-name="${item.name}" data-price="${item.price || 0}" data-img="${item.img}">
          ...
          <div class="product-info">
            <div class="product-brand">${item.category || "UMNUN"}</div>
    ...
    container.innerHTML = `
      ...
      <div class="product-view-layout product-view">
        ...
        <div class="product-view-details">
          <div>
            <span class="product-view-brand">UMNUN</span>
          ...
          <div class="product-view-description">
            ...
            <div class="product-view-description-text">${product.description || "Premium quality streetwear essential from the UMNUN collection. Built for those who refuse to stay in the shadows. Each piece is crafted with precision and designed for the future."}</div>
          </div>
