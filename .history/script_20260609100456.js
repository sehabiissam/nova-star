/**
 * JWS CLOTHING DZ | LUXURY STREETWEAR 2026
 * MAIN SCRIPT
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const STORAGE_KEY = 'jwsclothingdz-theme';
            ...
            <div class="product-card" data-id="${p.id}" data-name="${p.name}" data-price="${p.price}" data-img="${p.img}">
              ...
              <div class="product-info">
                <div class="product-info-left">
                  ...
                  <div class="product-desc">Premium quality streetwear essential from the JWS CLOTHING DZ collection.</div>
                </div>
    ...
    container.innerHTML = `
      ...
      <div class="product-view-layout product-view">
        ...
        <div class="product-view-details">
          <div>
            <span class="product-view-brand">JWS CLOTHING DZ</span>
          ...
          <div class="product-view-description">
            ...
            <div class="product-view-description-text">${product.description || "Premium quality streetwear essential from the JWS CLOTHING DZ collection. Built for those who refuse to stay in the shadows. Each piece is crafted with precision and designed for the future."}</div>
          </div>
